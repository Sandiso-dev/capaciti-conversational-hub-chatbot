  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-24">
      <div className="max-w-4xl mx-auto text-center space-y-8">
        <div className="inline-flex items-center justify-center px-4 py-1.5 mb-8 text-sm font-medium rounded-full border border-white/10 bg-white/5 text-white/70 backdrop-blur-sm">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white fade-in">
          Your CAPACITI Guide,{" "}
        ...
        <p className="text-xl text-white/70 max-w-2xl mx-auto fade-in">
